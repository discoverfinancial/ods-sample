...
customTheme = createTheme(customTheme, {
    components: {
        ...
        MuiOutlinedInput: {
            ...
            styleOverrides: {
                root: {
                    ...themes.dfsTheme.components.MuiOutlinedInput.styleOverrides.root,
                    minHeight: "25px",
                    borderRadius: "12px",
                    fontSize: "14px",
                    lineHeight: "21px",
            ...
            styleOverrides: {
                root: {
                    ...
                    "&.Mui-checked .MuiSvgIcon-root" : {
                        backgroundColor: customTheme.palette.primary.main + "20 !important",
                        boxShadow: "inset 0 0 0 2px " + customTheme.palette.primary.main + " !important",
                    },
                }
            }
        },

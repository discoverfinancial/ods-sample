...
const LogsPage: React.FC<Props> = ({ context }) => {
    window.document.title = "Logs";
    ...
    async function handleDeleteOlder(item: any) {
        ...
        const r = await logMgr.deleteMany({key:"surveyor-log", dateCreated: {$lt: date}});

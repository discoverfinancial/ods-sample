 ...
 */
export type ComponentLicenseS = ComponentLicenseS1; //bc: causes validation error => & ComponentLicenseS2;
export type ComponentLicenseS1 = MultipleLicenses | SPDXLicenseExpression;
 ...
 * @maxItems 1
 */
export type SPDXLicenseExpression = any;
...
export type ComponentLicenseS2 = unknown[];
/**
 ...
 * EITHER (list of SPDX licenses and/or named licenses) OR (tuple of one SPDX License Expression)
 */
export type LicenseEvidence = LicenseEvidence1 & LicenseEvidence2;
export type LicenseEvidence1 = MultipleLicenses | SPDXLicenseExpression;
export type LicenseEvidence2 = unknown[];
 ...
 */
export type DataStewards = DataGovernanceResponsibleParty1[];
/**
 * Data owners are concerned with risk and appropriate access to data.
 */
export type DataOwners = DataGovernanceResponsibleParty1[];
/**
 ...
 * EITHER (list of SPDX licenses and/or named licenses) OR (tuple of one SPDX License Expression)
 */
export type ComponentLicenseS3 = ComponentLicenseS4 //bc: causes validation error => & ComponentLicenseS5;
export type ComponentLicenseS4 = MultipleLicenses | SPDXLicenseExpression;
export type ComponentLicenseS5 = unknown[];
/**
 * External references provide a way to document systems, sites, and information that may be relevant but are not included with the BOM. They may also establish specific relationships within or external to the BOM.
 */
...
export type ComponentLicenseS6 = ComponentLicenseS1//bc: causes validation error => & ComponentLicenseS2; 
/**
 ...
 */
export type BOMLicenseS = BOMLicenseS1 & BOMLicenseS2;
export type BOMLicenseS1 = MultipleLicenses | SPDXLicenseExpression;
export type BOMLicenseS2 = unknown[];
/**
 * Provides the ability to document properties in a name-value store. This provides flexibility to include data not officially supported in the standard without having to use additional namespaces or create extensions. Unlike key-value stores, properties support duplicate names, each potentially having different values. Property names of interest to the general public are encouraged to be registered in the [CycloneDX Property Taxonomy](https://github.com/CycloneDX/cyclonedx-property-taxonomy). Formal registration is OPTIONAL.
 */
 ...
 * Represents resources and data output from a task at runtime by executor or task commands
 */
export type Outputs2 = OutputType1[];
/**
 ...
 * Represents resources and data output from a task at runtime by executor or task commands
 */
export type Outputs3 = OutputType1[];
/**
 * The date and time (timestamp) when the task started.
 */
 ...
 * Enveloped signature in [JSON Signature Format (JSF)](https://cyberphone.github.io/doc/security/jsf.html).
 */
export interface Signature7 {
  [k: string]: unknown;
}
/**
 * Enveloped signature in [JSON Signature Format (JSF)](https://cyberphone.github.io/doc/security/jsf.html).
 */
export interface Signature8 {
  [k: string]: unknown;
}
/**
 ...
 * Enveloped signature in [JSON Signature Format (JSF)](https://cyberphone.github.io/doc/security/jsf.html).
 */
export interface Signature9 {
  [k: string]: unknown;
}
/**
 * Enveloped signature in [JSON Signature Format (JSF)](https://cyberphone.github.io/doc/security/jsf.html).
 */
export interface Signature10 {
  [k: string]: unknown;
}

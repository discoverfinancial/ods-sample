...
ODS Sample is part of the [ODS Framework](https://www.github.com/discoverfinancial/ods-framework) family.  ODS Sample endeavors to demonstrate an ODS in simpler terms.  It takes two approaches, ODS App and ODS Client.  Continue reading to learn more about each.

## ODS App

ODS App provides a playground where the features of ODS Framework can be easily explored but with far fewer data types and UI panels to sort through as you learn about ODS.  ODS App can also be used as a foundation upon which to build a more enhanced ODS application.

[Learn more about ODS App](./ods-app/README.md)

## ODS Client

ODS Client is a true web-based client application that exercises the ODS Framework API or ODS App API (subset of the ODS Framework API) in order to display the data available in a running ODS.  This would be a good foundation upon which to build a user experience tailored to your user's needs.
